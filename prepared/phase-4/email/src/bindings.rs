...
pub mod demo {
    ...
    pub mod lst_stub {
        ...
        pub mod stub_lst {
            ...
            pub type Connection = super::super::super::demo::lst::api::Connection;
            pub type Change = super::super::super::demo::lst::api::Change;
            ...
            unsafe impl _rt::WasmResource for FutureGetResult {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
            ...
            impl FuturePollResult {
                ...
                pub fn subscribe(&self) -> WasiIoPollable {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-poll-result.subscribe"]
                            fn wit_import(_: i32) -> i32;
                        }
            ...
            impl FuturePollResult {
                #[allow(unused_unsafe, clippy::all)]
                pub fn get(&self) -> Option<_rt::Vec<Change>> {
                    unsafe {
                        #[repr(align(4))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-poll-result.get"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
                            ...
                            1 => {
                                let e = {
                                    ...
                                    for i in 0..len18 {
                                        ...
                                        let e18 = {
                                            let l4 = i32::from(*base.add(0).cast::<u8>());
                                            use super::super::super::demo::lst::api::Change as V17;
                                            let v17 = match l4 {
                                                0 => {
                                                    let e17 = {
                                                        let l5 = *base.add(4).cast::<*mut u8>();
                                                ...
                                                n => {
                                                    ...
                                                    let e17 = {
                                                        ...
                                                        super::super::super::demo::lst::api::InsertParams{
                              after: _rt::string_lift(bytes13),
                              value: _rt::string_lift(bytes16),
                            }
                                                    };
            ...
            impl FutureConnectResult {
                ...
                pub fn subscribe(&self) -> WasiIoPollable {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-connect-result.subscribe"]
                            fn wit_import(_: i32) -> i32;
                        }
            ...
            impl FutureConnectResult {
                ...
                pub fn get(&self) -> Option<Connection> {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-connect-result.get"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
                        ...
                        match l1 {
                            ...
                            1 => {
                                let e = {
                                    ...
                                    super::super::super::demo::lst::api::Connection {
                                        id: l2 as u64,
                                    }
                                };
                                Some(e)
            ...
            impl FutureConnectedEditorsResult {
                ...
                pub fn subscribe(&self) -> WasiIoPollable {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-connected-editors-result.subscribe"]
                            fn wit_import(_: i32) -> i32;
                        }
            ...
            impl FutureConnectedEditorsResult {
                ...
                pub fn get(&self) -> Option<_rt::Vec<_rt::String>> {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-connected-editors-result.get"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
            ...
            impl FutureIsArchivedResult {
                ...
                pub fn subscribe(&self) -> WasiIoPollable {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-is-archived-result.subscribe"]
                            fn wit_import(_: i32) -> i32;
                        }
            ...
            impl FutureIsArchivedResult {
                ...
                pub fn get(&self) -> Option<bool> {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-is-archived-result.get"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
            ...
            impl FutureDeadlineResult {
                ...
                pub fn subscribe(&self) -> WasiIoPollable {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-deadline-result.subscribe"]
                            fn wit_import(_: i32) -> i32;
                        }
            ...
            impl FutureDeadlineResult {
                #[allow(unused_unsafe, clippy::all)]
                pub fn get(&self) -> Option<Option<u64>> {
                    unsafe {
                        #[repr(align(8))]
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-deadline-result.get"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
            ...
            impl FutureRecipientsResult {
                ...
                pub fn subscribe(&self) -> WasiIoPollable {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-recipients-result.subscribe"]
                            fn wit_import(_: i32) -> i32;
                        }
            ...
            impl FutureRecipientsResult {
                ...
                pub fn get(&self) -> Option<_rt::Vec<_rt::String>> {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]future-recipients-result.get"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_add(&self, c: Connection, value: &str) {
                    unsafe {
                        let super::super::super::demo::lst::api::Connection { id: id0 } = c;
                        let vec1 = value;
                        let ptr1 = vec1.as_ptr().cast::<u8>();
                        let len1 = vec1.len();
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.blocking-add"]
                            fn wit_import(_: i32, _: i64, _: *mut u8, _: usize);
                        }
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn add(&self, c: Connection, value: &str) {
                    unsafe {
                        let super::super::super::demo::lst::api::Connection { id: id0 } = c;
                        let vec1 = value;
                        let ptr1 = vec1.as_ptr().cast::<u8>();
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_delete(&self, c: Connection, value: &str) {
                    unsafe {
                        let super::super::super::demo::lst::api::Connection { id: id0 } = c;
                        let vec1 = value;
                        let ptr1 = vec1.as_ptr().cast::<u8>();
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.blocking-delete"]
                            fn wit_import(_: i32, _: i64, _: *mut u8, _: usize);
                        }
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn delete(&self, c: Connection, value: &str) {
                    unsafe {
                        let super::super::super::demo::lst::api::Connection { id: id0 } = c;
                        let vec1 = value;
                        let ptr1 = vec1.as_ptr().cast::<u8>();
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_insert(&self, c: Connection, after: &str, value: &str) {
                    unsafe {
                        let super::super::super::demo::lst::api::Connection { id: id0 } = c;
                        let vec1 = after;
                        let ptr1 = vec1.as_ptr().cast::<u8>();
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.blocking-insert"]
                            fn wit_import(
                                _: i32,
                                _: i64,
                                _: *mut u8,
                        ...
                        #[cfg(not(target_arch = "wasm32"))]
                        fn wit_import(_: i32, _: i64, _: *mut u8, _: usize, _: *mut u8, _: usize) {
                            unreachable!()
                        }
                        wit_import(
                            (self).handle() as i32,
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn insert(&self, c: Connection, after: &str, value: &str) {
                    unsafe {
                        let super::super::super::demo::lst::api::Connection { id: id0 } = c;
                        let vec1 = after;
                        let ptr1 = vec1.as_ptr().cast::<u8>();
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_get(&self) -> _rt::Vec<_rt::String> {
                    unsafe {
                        #[repr(align(4))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
                        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_poll(&self, c: Connection) -> _rt::Vec<Change> {
                    unsafe {
                        #[repr(align(4))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
                        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.blocking-poll"]
                        ...
                        wit_import((self).handle() as i32, _rt::as_i64(id0), ptr1);
                        let l2 = *ptr1.add(0).cast::<*mut u8>();
                        let l3 = *ptr1.add(4).cast::<usize>();
                        let base18 = l2;
                        let len18 = l3;
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn poll(&self, c: Connection) -> FuturePollResult {
                    unsafe {
                        let super::super::super::demo::lst::api::Connection { id: id0 } = c;
                        ...
                        let ret = wit_import((self).handle() as i32, _rt::as_i64(id0));
                        FuturePollResult::from_handle(ret as u32)
                    }
                }
            }
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_connect(&self, email: &str) -> Connection {
                    unsafe {
                        let vec0 = email;
                        let ptr0 = vec0.as_ptr().cast::<u8>();
                        let len0 = vec0.len();
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.blocking-connect"]
                            fn wit_import(_: i32, _: *mut u8, _: usize) -> i64;
                        }
                        ...
                        super::super::super::demo::lst::api::Connection { id: ret as u64 }
                    }
                }
            }
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn connect(&self, email: &str) -> FutureConnectResult {
                    unsafe {
                        let vec0 = email;
                        let ptr0 = vec0.as_ptr().cast::<u8>();
                        let len0 = vec0.len();
                        ...
                        let ret = wit_import((self).handle() as i32, ptr0.cast_mut(), len0);
                        FutureConnectResult::from_handle(ret as u32)
                    }
                }
            }
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_disconnect(&self, c: Connection) {
                    unsafe {
                        let super::super::super::demo::lst::api::Connection { id: id0 } = c;
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.blocking-disconnect"]
                        ...
                        wit_import((self).handle() as i32, _rt::as_i64(id0));
                    }
                }
            }
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn disconnect(&self, c: Connection) {
                    unsafe {
                        let super::super::super::demo::lst::api::Connection { id: id0 } = c;
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.disconnect"]
                            fn wit_import(_: i32, _: i64);
                        }
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_connected_editors(&self) -> _rt::Vec<_rt::String> {
                    unsafe {
                        #[repr(align(4))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
                        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.blocking-connected-editors"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn connected_editors(&self) -> FutureConnectedEditorsResult {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.connected-editors"]
                            fn wit_import(_: i32) -> i32;
                        }
                        ...
                        let ret = wit_import((self).handle() as i32);
                        FutureConnectedEditorsResult::from_handle(ret as u32)
                    }
                }
            }
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_archive(&self) {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.blocking-archive"]
                            fn wit_import(_: i32);
                        }
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_is_archived(&self) -> bool {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.blocking-is-archived"]
                            fn wit_import(_: i32) -> i32;
                        }
            ...
            impl Api {
                #[allow(unused_unsafe, clippy::all)]
                pub fn is_archived(&self) -> FutureIsArchivedResult {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]api.is-archived"]
                            fn wit_import(_: i32) -> i32;
                        }
                        ...
                        let ret = wit_import((self).handle() as i32);
                        FutureIsArchivedResult::from_handle(ret as u32)
                    }
                }
            }
            impl EmailQuery {
                ...
                pub fn new(location: &GolemRpcUri) -> Self {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[constructor]email-query"]
                            fn wit_import(_: *mut u8, _: usize) -> i32;
                        }
                        ...
                        let ret = wit_import(ptr1.cast_mut(), len1);
                        EmailQuery::from_handle(ret as u32)
                    }
                }
            }
            impl EmailQuery {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_deadline(&self) -> Option<u64> {
                    unsafe {
                        #[repr(align(8))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 16]);
                        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 16]);
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]email-query.blocking-deadline"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
            ...
            impl EmailQuery {
                #[allow(unused_unsafe, clippy::all)]
                pub fn deadline(&self) -> FutureDeadlineResult {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]email-query.deadline"]
                            fn wit_import(_: i32) -> i32;
                        }
                        ...
                        let ret = wit_import((self).handle() as i32);
                        FutureDeadlineResult::from_handle(ret as u32)
                    }
                }
            }
            impl EmailQuery {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_recipients(&self) -> _rt::Vec<_rt::String> {
                    unsafe {
                        #[repr(align(4))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
                        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
                        ...
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]email-query.blocking-recipients"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
            ...
            impl EmailQuery {
                #[allow(unused_unsafe, clippy::all)]
                pub fn recipients(&self) -> FutureRecipientsResult {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(wasm_import_module = "demo:lst-stub/stub-lst")]
                        extern "C" {
                            #[link_name = "[method]email-query.recipients"]
                            fn wit_import(_: i32) -> i32;
                        }
                        ...
                        let ret = wit_import((self).handle() as i32);
                        FutureRecipientsResult::from_handle(ret as u32)
                    }
                }
            }
        }
    ...
    pub mod demo {
        ...
        pub mod email {
            ...
            pub mod api {
                ...
                pub unsafe fn _export_send_email_cabi<T: Guest>(arg0: *mut u8, arg1: usize) {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    T::send_email(super::super::super::super::golem::rpc::types::Uri {
                        value: _rt::string_lift(bytes0),
                    });
                }
                pub trait Guest {
                    fn send_email(list_uri: Uri);
                }
                #[doc(hidden)]

                macro_rules! __export_demo_email_api_cabi{
                                      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

                                        #[export_name = "demo:email/api#send-email"]
                                        unsafe extern "C" fn export_send_email(arg0: *mut u8,arg1: usize,) {
                                          $($path_to_types)*::_export_send_email_cabi::<$ty>(arg0, arg1)
                                        }
                                      };);
                                    }
                #[doc(hidden)]
                pub(crate) use __export_demo_email_api_cabi;
            }
        }
    }
}
...
macro_rules! __export_email_impl {
                              ($ty:ident) => (self::export!($ty with_types_in self););
                              ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
                              $($path_to_types_root)*::exports::demo::email::api::__export_demo_email_api_cabi!($ty with_types_in $($path_to_types_root)*::exports::demo::email::api);
                              )
                            }
#[doc(inline)]
pub(crate) use __export_email_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:email:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 4000] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa4\x1e\x01A\x02\x01\
...
\x04self\xc8\0\0\xcd\0\x04\0\x1e[method]email-query.recipients\x01N\x03\x01\x16d\
emo:lst-stub/stub-lst\x05\x08\x01B\x04\x02\x03\x02\x01\x04\x04\0\x03uri\x03\0\0\x01\
@\x01\x08list-uri\x01\x01\0\x04\0\x0asend-email\x01\x02\x04\x01\x0edemo:email/ap\
i\x05\x09\x04\x01\x10demo:email/email\x04\0\x0b\x0b\x01\0\x05email\x03\0\0\0G\x09\
