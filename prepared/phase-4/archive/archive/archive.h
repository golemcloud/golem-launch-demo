...
#ifndef __BINDINGS_ARCHIVE_H
#define __BINDINGS_ARCHIVE_H
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct archive_string_t {
  uint8_t*ptr;
  size_t len;
} archive_string_t;
...
typedef int32_t golem_rpc_types_node_index_t;

typedef struct golem_rpc_types_uri_t {
  archive_string_t   value;
} golem_rpc_types_uri_t;

typedef struct {
  golem_rpc_types_node_index_t *ptr;
  size_t len;
} archive_list_node_index_t;

typedef struct {
  bool is_some;
  golem_rpc_types_node_index_t val;
} archive_option_node_index_t;

typedef struct {
  uint32_t f0;
  archive_option_node_index_t f1;
} archive_tuple2_u32_option_node_index_t;
...
typedef struct {
  bool is_err;
  union {
    archive_option_node_index_t ok;
    archive_option_node_index_t err;
  } val;
} golem_rpc_types_result_option_node_index_option_node_index_t;

typedef struct {
  golem_rpc_types_uri_t f0;
  uint64_t f1;
} golem_rpc_types_tuple2_uri_u64_t;

typedef struct golem_rpc_types_wit_node_t {
  uint8_t tag;
  union {
    archive_list_node_index_t     record_value;
    archive_tuple2_u32_option_node_index_t     variant_value;
    uint32_t     enum_value;
    archive_list_bool_t     flags_value;
    archive_list_node_index_t     tuple_value;
    archive_list_node_index_t     list_value;
    archive_option_node_index_t     option_value;
    golem_rpc_types_result_option_node_index_option_node_index_t     result_value;
    uint8_t     prim_u8;
    uint16_t     prim_u16;
    uint32_t     prim_u32;
    uint64_t     prim_u64;
    ...
    uint32_t     prim_char;
    bool     prim_bool;
    archive_string_t     prim_string;
    golem_rpc_types_tuple2_uri_u64_t     handle;
  } val;
} golem_rpc_types_wit_node_t;

#define GOLEM_RPC_TYPES_WIT_NODE_RECORD_VALUE 0
#define GOLEM_RPC_TYPES_WIT_NODE_VARIANT_VALUE 1
#define GOLEM_RPC_TYPES_WIT_NODE_ENUM_VALUE 2
#define GOLEM_RPC_TYPES_WIT_NODE_FLAGS_VALUE 3
#define GOLEM_RPC_TYPES_WIT_NODE_TUPLE_VALUE 4
#define GOLEM_RPC_TYPES_WIT_NODE_LIST_VALUE 5
#define GOLEM_RPC_TYPES_WIT_NODE_OPTION_VALUE 6
#define GOLEM_RPC_TYPES_WIT_NODE_RESULT_VALUE 7
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_U8 8
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_U16 9
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_U32 10
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_U64 11
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_S8 12
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_S16 13
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_S32 14
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_S64 15
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_FLOAT32 16
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_FLOAT64 17
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_CHAR 18
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_BOOL 19
#define GOLEM_RPC_TYPES_WIT_NODE_PRIM_STRING 20
#define GOLEM_RPC_TYPES_WIT_NODE_HANDLE 21

typedef struct {
  golem_rpc_types_wit_node_t *ptr;
  size_t len;
} golem_rpc_types_list_wit_node_t;

typedef struct golem_rpc_types_wit_value_t {
  golem_rpc_types_list_wit_node_t   nodes;
} golem_rpc_types_wit_value_t;

typedef struct golem_rpc_types_rpc_error_t {
  uint8_t tag;
  union {
    archive_string_t     protocol_error;
    archive_string_t     denied;
    archive_string_t     not_found;
    archive_string_t     remote_internal_error;
  } val;
} golem_rpc_types_rpc_error_t;

#define GOLEM_RPC_TYPES_RPC_ERROR_PROTOCOL_ERROR 0
#define GOLEM_RPC_TYPES_RPC_ERROR_DENIED 1
#define GOLEM_RPC_TYPES_RPC_ERROR_NOT_FOUND 2
#define GOLEM_RPC_TYPES_RPC_ERROR_REMOTE_INTERNAL_ERROR 3

typedef struct golem_rpc_types_own_wasm_rpc_t {
  int32_t __handle;
} golem_rpc_types_own_wasm_rpc_t;

typedef struct golem_rpc_types_borrow_wasm_rpc_t {
  int32_t __handle;
} golem_rpc_types_borrow_wasm_rpc_t;

typedef struct golem_rpc_types_own_future_invoke_result_t {
  int32_t __handle;
} golem_rpc_types_own_future_invoke_result_t;

typedef struct golem_rpc_types_borrow_future_invoke_result_t {
  int32_t __handle;
} golem_rpc_types_borrow_future_invoke_result_t;

typedef struct {
  golem_rpc_types_wit_value_t *ptr;
  size_t len;
} golem_rpc_types_list_wit_value_t;

typedef struct {
  bool is_err;
  union {
    golem_rpc_types_wit_value_t ok;
    golem_rpc_types_rpc_error_t err;
  } val;
} golem_rpc_types_result_wit_value_rpc_error_t;
...
} golem_rpc_types_result_void_rpc_error_t;

typedef wasi_io_poll_own_pollable_t golem_rpc_types_own_pollable_t;

typedef struct {
  bool is_some;
  golem_rpc_types_result_wit_value_rpc_error_t val;
} golem_rpc_types_option_result_wit_value_rpc_error_t;
...
typedef struct {
  archive_string_t *ptr;
  size_t len;
} archive_list_string_t;

typedef struct {
  archive_string_t f0;
  archive_string_t f1;
} archive_tuple2_string_string_t;

typedef struct {
  archive_tuple2_string_string_t *ptr;
  size_t len;
} archive_list_tuple2_string_string_t;

typedef struct golem_api_host_worker_metadata_t {
  golem_api_host_worker_id_t   worker_id;
  archive_list_string_t   args;
  archive_list_tuple2_string_string_t   env;
...
typedef archive_string_t wasi_blobstore_types_container_name_t;

// name of an object within a container
// The object name may be any valid UTF-8 string.
typedef archive_string_t wasi_blobstore_types_object_name_t;
...
typedef archive_string_t wasi_blobstore_types_error_t;

// information about a container
typedef struct wasi_blobstore_types_container_metadata_t {
...
typedef struct wasi_blobstore_types_object_metadata_t {
  // the object's name
...
typedef struct wasi_blobstore_types_object_id_t {
  wasi_blobstore_types_container_name_t   container;
  wasi_blobstore_types_object_name_t   object;
} wasi_blobstore_types_object_id_t;

typedef struct wasi_blobstore_types_own_outgoing_value_t {
  int32_t __handle;
} wasi_blobstore_types_own_outgoing_value_t;

typedef struct wasi_blobstore_types_borrow_outgoing_value_t {
  int32_t __handle;
} wasi_blobstore_types_borrow_outgoing_value_t;

typedef struct wasi_blobstore_types_own_incoming_value_t {
  int32_t __handle;
} wasi_blobstore_types_own_incoming_value_t;

typedef struct wasi_blobstore_types_borrow_incoming_value_t {
  int32_t __handle;
} wasi_blobstore_types_borrow_incoming_value_t;

typedef struct wasi_blobstore_types_incoming_value_sync_body_t {
  uint8_t   *ptr;
  size_t len;
} wasi_blobstore_types_incoming_value_sync_body_t;

typedef wasi_io_streams_own_output_stream_t wasi_blobstore_types_own_output_stream_t;

typedef struct {
  bool is_err;
  union {
    wasi_blobstore_types_own_output_stream_t ok;
  } val;
} wasi_blobstore_types_result_own_output_stream_void_t;
...
} wasi_blobstore_types_result_incoming_value_sync_body_error_t;

typedef wasi_io_streams_own_input_stream_t wasi_blobstore_types_own_incoming_value_async_body_t;

typedef struct {
  bool is_err;
  union {
    wasi_blobstore_types_own_incoming_value_async_body_t ok;
    wasi_blobstore_types_error_t err;
  } val;
} wasi_blobstore_types_result_own_incoming_value_async_body_error_t;
...
typedef struct wasi_blobstore_container_own_container_t {
  int32_t __handle;
} wasi_blobstore_container_own_container_t;

typedef struct wasi_blobstore_container_borrow_container_t {
  int32_t __handle;
} wasi_blobstore_container_borrow_container_t;

typedef struct wasi_blobstore_container_own_stream_object_names_t {
  int32_t __handle;
} wasi_blobstore_container_own_stream_object_names_t;

typedef struct wasi_blobstore_container_borrow_stream_object_names_t {
  int32_t __handle;
} wasi_blobstore_container_borrow_stream_object_names_t;
...
} wasi_blobstore_container_result_string_error_t;
...
} wasi_blobstore_container_result_container_metadata_error_t;

typedef wasi_blobstore_types_own_incoming_value_t wasi_blobstore_container_own_incoming_value_t;

typedef struct {
  bool is_err;
  union {
    wasi_blobstore_container_own_incoming_value_t ok;
    wasi_blobstore_container_error_t err;
  } val;
} wasi_blobstore_container_result_own_incoming_value_error_t;

typedef wasi_blobstore_types_borrow_outgoing_value_t wasi_blobstore_container_borrow_outgoing_value_t;
...
} wasi_blobstore_container_result_void_error_t;

typedef struct {
  bool is_err;
  union {
    wasi_blobstore_container_own_stream_object_names_t ok;
    wasi_blobstore_container_error_t err;
  } val;
} wasi_blobstore_container_result_own_stream_object_names_error_t;

typedef struct {
  wasi_blobstore_container_object_name_t *ptr;
  size_t len;
} archive_list_object_name_t;
...
} wasi_blobstore_container_result_bool_error_t;
...
} wasi_blobstore_container_result_object_metadata_error_t;

typedef struct {
  archive_list_object_name_t f0;
  bool f1;
} archive_tuple2_list_object_name_bool_t;

typedef struct {
  bool is_err;
  union {
    archive_tuple2_list_object_name_bool_t ok;
    wasi_blobstore_container_error_t err;
  } val;
} wasi_blobstore_container_result_tuple2_list_object_name_bool_error_t;

typedef struct {
  uint64_t f0;
  bool f1;
} archive_tuple2_u64_bool_t;

typedef struct {
  bool is_err;
  union {
    archive_tuple2_u64_bool_t ok;
    wasi_blobstore_container_error_t err;
  } val;
} wasi_blobstore_container_result_tuple2_u64_bool_error_t;
...
typedef wasi_blobstore_container_own_container_t wasi_blobstore_blobstore_own_container_t;

typedef struct {
  bool is_err;
  union {
    wasi_blobstore_blobstore_own_container_t ok;
    wasi_blobstore_blobstore_error_t err;
  } val;
} wasi_blobstore_blobstore_result_own_container_error_t;
...
} wasi_blobstore_blobstore_result_void_error_t;
...
typedef struct {
  bool is_some;
  archive_string_t val;
} archive_option_string_t;
...
typedef struct {
  archive_list_u8_t f0;
  bool f1;
} archive_tuple2_list_u8_bool_t;

typedef struct {
  bool is_err;
  union {
    archive_tuple2_list_u8_bool_t ok;
    wasi_filesystem_types_error_code_t err;
  } val;
...
typedef struct {
  bool is_some;
  uint16_t val;
} archive_option_u16_t;

// Defines the case payload type for `DNS-error` above:
typedef struct wasi_http_types_dns_error_payload_t {
  archive_option_string_t   rcode;
  archive_option_u16_t   info_code;
...
typedef struct wasi_http_types_tls_alert_received_payload_t {
  archive_option_u8_t   alert_id;
  archive_option_string_t   alert_message;
} wasi_http_types_tls_alert_received_payload_t;

typedef struct {
  bool is_some;
  uint32_t val;
} archive_option_u32_t;

// Defines the case payload type for `HTTP-response-{header,trailer}-size` above:
typedef struct wasi_http_types_field_size_payload_t {
  archive_option_string_t   field_name;
  archive_option_u32_t   field_size;
} wasi_http_types_field_size_payload_t;

typedef struct {
  bool is_some;
  uint64_t val;
} archive_option_u64_t;
...
typedef struct wasi_http_types_error_code_t {
  ...
  union {
    ...
    archive_option_u64_t     http_request_body_size;
    archive_option_u32_t     http_request_header_section_size;
    wasi_http_types_option_field_size_payload_t     http_request_header_size;
    archive_option_u32_t     http_request_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_request_trailer_size;
    archive_option_u32_t     http_response_header_section_size;
    wasi_http_types_field_size_payload_t     http_response_header_size;
    archive_option_u64_t     http_response_body_size;
    archive_option_u32_t     http_response_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_response_trailer_size;
    archive_option_string_t     http_response_transfer_coding;
    archive_option_string_t     http_response_content_coding;
    archive_option_string_t     internal_error;
  } val;
...
typedef archive_string_t wasi_http_types_field_key_t;
...
} archive_tuple2_field_key_field_value_t;

typedef struct {
  archive_tuple2_field_key_field_value_t *ptr;
  size_t len;
} archive_list_tuple2_field_key_field_value_t;
...
typedef struct exports_demo_archive_api_archived_list_t {
  archive_string_t   name;
  archive_list_string_t   items;
} exports_demo_archive_api_archived_list_t;

typedef struct {
  exports_demo_archive_api_archived_list_t *ptr;
  size_t len;
} exports_demo_archive_api_list_archived_list_t;
...
extern void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, archive_list_u32_t *ret);

// Imported Functions from `golem:rpc/types@0.1.0`
extern golem_rpc_types_own_wasm_rpc_t golem_rpc_types_constructor_wasm_rpc(golem_rpc_types_uri_t *location);
extern void golem_rpc_types_method_wasm_rpc_invoke_and_await(golem_rpc_types_borrow_wasm_rpc_t self, archive_string_t *function_name, golem_rpc_types_list_wit_value_t *function_params, golem_rpc_types_result_wit_value_rpc_error_t *ret);
extern void golem_rpc_types_method_wasm_rpc_invoke(golem_rpc_types_borrow_wasm_rpc_t self, archive_string_t *function_name, golem_rpc_types_list_wit_value_t *function_params, golem_rpc_types_result_void_rpc_error_t *ret);
extern golem_rpc_types_own_future_invoke_result_t golem_rpc_types_method_wasm_rpc_async_invoke_and_await(golem_rpc_types_borrow_wasm_rpc_t self, archive_string_t *function_name, golem_rpc_types_list_wit_value_t *function_params);
extern golem_rpc_types_own_pollable_t golem_rpc_types_method_future_invoke_result_subscribe(golem_rpc_types_borrow_future_invoke_result_t self);
extern void golem_rpc_types_method_future_invoke_result_get(golem_rpc_types_borrow_future_invoke_result_t self, golem_rpc_types_option_result_wit_value_rpc_error_t *ret);
...
extern void golem_api_host_await_promise(golem_api_host_promise_id_t *promise_id, archive_list_u8_t *ret);
...
extern bool golem_api_host_complete_promise(golem_api_host_promise_id_t *promise_id, archive_list_u8_t *data);
...
extern void golem_api_host_get_self_uri(archive_string_t *function_name, golem_api_host_uri_t *ret);
...
// hazard.
extern void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, archive_string_t *ret);
...
extern void wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, archive_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret);
...
// ```
extern void wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, archive_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret);
...
extern wasi_blobstore_types_own_outgoing_value_t wasi_blobstore_types_static_outgoing_value_new_outgoing_value(void);
extern void wasi_blobstore_types_method_outgoing_value_outgoing_value_write_body(wasi_blobstore_types_borrow_outgoing_value_t self, wasi_blobstore_types_result_own_output_stream_void_t *ret);
extern void wasi_blobstore_types_method_incoming_value_incoming_value_consume_sync(wasi_blobstore_types_borrow_incoming_value_t self, wasi_blobstore_types_result_incoming_value_sync_body_error_t *ret);
extern void wasi_blobstore_types_method_incoming_value_incoming_value_consume_async(wasi_blobstore_types_borrow_incoming_value_t self, wasi_blobstore_types_result_own_incoming_value_async_body_error_t *ret);
extern uint64_t wasi_blobstore_types_method_incoming_value_size(wasi_blobstore_types_borrow_incoming_value_t self);

// Imported Functions from `wasi:blobstore/container`
// returns container name
extern void wasi_blobstore_container_method_container_name(wasi_blobstore_container_borrow_container_t self, wasi_blobstore_container_result_string_error_t *ret);
// returns container metadata
extern void wasi_blobstore_container_method_container_info(wasi_blobstore_container_borrow_container_t self, wasi_blobstore_container_result_container_metadata_error_t *ret);
...
extern void wasi_blobstore_container_method_container_get_data(wasi_blobstore_container_borrow_container_t self, wasi_blobstore_container_object_name_t *name, uint64_t start, uint64_t end, wasi_blobstore_container_result_own_incoming_value_error_t *ret);
// creates or replaces an object with the data blob.
extern void wasi_blobstore_container_method_container_write_data(wasi_blobstore_container_borrow_container_t self, wasi_blobstore_container_object_name_t *name, wasi_blobstore_container_borrow_outgoing_value_t data, wasi_blobstore_container_result_void_error_t *ret);
// returns list of objects in the container. Order is undefined.
extern void wasi_blobstore_container_method_container_list_objects(wasi_blobstore_container_borrow_container_t self, wasi_blobstore_container_result_own_stream_object_names_error_t *ret);
// deletes object.
// does not return error if object did not exist.
extern void wasi_blobstore_container_method_container_delete_object(wasi_blobstore_container_borrow_container_t self, wasi_blobstore_container_object_name_t *name, wasi_blobstore_container_result_void_error_t *ret);
// deletes multiple objects in the container
extern void wasi_blobstore_container_method_container_delete_objects(wasi_blobstore_container_borrow_container_t self, archive_list_object_name_t *names, wasi_blobstore_container_result_void_error_t *ret);
// returns true if the object exists in this container
extern void wasi_blobstore_container_method_container_has_object(wasi_blobstore_container_borrow_container_t self, wasi_blobstore_container_object_name_t *name, wasi_blobstore_container_result_bool_error_t *ret);
// returns metadata for the object
extern void wasi_blobstore_container_method_container_object_info(wasi_blobstore_container_borrow_container_t self, wasi_blobstore_container_object_name_t *name, wasi_blobstore_container_result_object_metadata_error_t *ret);
// removes all objects within the container, leaving the container empty.
extern void wasi_blobstore_container_method_container_clear(wasi_blobstore_container_borrow_container_t self, wasi_blobstore_container_result_void_error_t *ret);
...
extern void wasi_blobstore_container_method_stream_object_names_read_stream_object_names(wasi_blobstore_container_borrow_stream_object_names_t self, uint64_t len, wasi_blobstore_container_result_tuple2_list_object_name_bool_error_t *ret);
...
extern void wasi_blobstore_container_method_stream_object_names_skip_stream_object_names(wasi_blobstore_container_borrow_stream_object_names_t self, uint64_t num, wasi_blobstore_container_result_tuple2_u64_bool_error_t *ret);

// Imported Functions from `wasi:blobstore/blobstore`
// creates a new empty container
extern void wasi_blobstore_blobstore_create_container(wasi_blobstore_blobstore_container_name_t *name, wasi_blobstore_blobstore_result_own_container_error_t *ret);
// retrieves a container by name
extern void wasi_blobstore_blobstore_get_container(wasi_blobstore_blobstore_container_name_t *name, wasi_blobstore_blobstore_result_own_container_error_t *ret);
// deletes a container and all objects within it
extern void wasi_blobstore_blobstore_delete_container(wasi_blobstore_blobstore_container_name_t *name, wasi_blobstore_blobstore_result_void_error_t *ret);
// returns true if the container exists
extern void wasi_blobstore_blobstore_container_exists(wasi_blobstore_blobstore_container_name_t *name, wasi_blobstore_blobstore_result_bool_error_t *ret);
...
extern void wasi_blobstore_blobstore_copy_object(wasi_blobstore_blobstore_object_id_t *src, wasi_blobstore_blobstore_object_id_t *dest, wasi_blobstore_blobstore_result_void_error_t *ret);
...
extern void wasi_cli_environment_get_environment(archive_list_tuple2_string_string_t *ret);
// Get the POSIX-style arguments to the program.
extern void wasi_cli_environment_get_arguments(archive_list_string_t *ret);
// Return a path that programs should use as their initial current working
// directory, interpreting `.` as shorthand for this.
extern void wasi_cli_environment_initial_cwd(archive_option_string_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_write(wasi_filesystem_types_borrow_descriptor_t self, archive_list_u8_t *buffer, wasi_filesystem_types_filesize_t offset, wasi_filesystem_types_result_filesize_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_create_directory_at(wasi_filesystem_types_borrow_descriptor_t self, archive_string_t *path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_stat_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, archive_string_t *path, wasi_filesystem_types_result_descriptor_stat_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_link_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t old_path_flags, archive_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, archive_string_t *new_path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_open_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, archive_string_t *path, wasi_filesystem_types_open_flags_t open_flags, wasi_filesystem_types_descriptor_flags_t flags, wasi_filesystem_types_result_own_descriptor_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_readlink_at(wasi_filesystem_types_borrow_descriptor_t self, archive_string_t *path, wasi_filesystem_types_result_string_error_code_t *ret);
// Remove a directory.
// 
// Return `error-code::not-empty` if the directory is not empty.
// 
// Note: This is similar to `unlinkat(fd, path, AT_REMOVEDIR)` in POSIX.
extern void wasi_filesystem_types_method_descriptor_remove_directory_at(wasi_filesystem_types_borrow_descriptor_t self, archive_string_t *path, wasi_filesystem_types_result_void_error_code_t *ret);
// Rename a filesystem object.
// 
// Note: This is similar to `renameat` in POSIX.
extern void wasi_filesystem_types_method_descriptor_rename_at(wasi_filesystem_types_borrow_descriptor_t self, archive_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, archive_string_t *new_path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_symlink_at(wasi_filesystem_types_borrow_descriptor_t self, archive_string_t *old_path, archive_string_t *new_path, wasi_filesystem_types_result_void_error_code_t *ret);
// Unlink a filesystem object that is not a directory.
// 
// Return `error-code::is-directory` if the path refers to a directory.
// Note: This is similar to `unlinkat(fd, path, 0)` in POSIX.
extern void wasi_filesystem_types_method_descriptor_unlink_file_at(wasi_filesystem_types_borrow_descriptor_t self, archive_string_t *path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_metadata_hash_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, archive_string_t *path, wasi_filesystem_types_result_metadata_hash_value_error_code_t *ret);
...
extern void wasi_http_types_static_fields_from_list(archive_list_tuple2_field_key_field_value_t *entries, wasi_http_types_result_own_fields_header_error_t *ret);
// Get all of the values corresponding to a key. If the key is not present
// in this `fields`, an empty list is returned. However, if the key is
// present but empty, this is represented by a list with one or more
// empty field-values present.
extern void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_key_t *name, archive_list_field_value_t *ret);
...
extern void wasi_http_types_method_fields_set(wasi_http_types_borrow_fields_t self, wasi_http_types_field_key_t *name, archive_list_field_value_t *value, wasi_http_types_result_void_header_error_t *ret);
...
// which have multiple values are represented by multiple entries in this
// list with the same key.
extern void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, archive_list_tuple2_field_key_field_value_t *ret);
...
extern void wasi_http_types_method_incoming_request_path_with_query(wasi_http_types_borrow_incoming_request_t self, archive_option_string_t *ret);
...
extern void wasi_http_types_method_incoming_request_authority(wasi_http_types_borrow_incoming_request_t self, archive_option_string_t *ret);
...
extern void wasi_http_types_method_outgoing_request_path_with_query(wasi_http_types_borrow_outgoing_request_t self, archive_option_string_t *ret);
// Set the combination of the HTTP Path and Query for the Request.
// When `none`, this represents an empty Path and empty Query. Fails is the
// string given is not a syntactically valid path and query uri component.
extern void wasi_http_types_method_outgoing_request_set_path_with_query(wasi_http_types_borrow_outgoing_request_t self, archive_option_string_t *path_with_query, wasi_http_types_result_void_void_t *ret);
...
extern void wasi_http_types_method_outgoing_request_authority(wasi_http_types_borrow_outgoing_request_t self, archive_option_string_t *ret);
// Set the HTTP Authority for the Request. A value of `none` may be used
// with Related Schemes which do not require an Authority. The HTTP and
// HTTPS schemes always require an authority. Fails if the string given is
// not a syntactically valid uri authority.
extern void wasi_http_types_method_outgoing_request_set_authority(wasi_http_types_borrow_outgoing_request_t self, archive_option_string_t *authority, wasi_http_types_result_void_void_t *ret);
// Get the headers associated with the Request.
// 
// The returned `headers` resource is immutable: `set`, `append`, and
// `delete` operations will fail with `header-error.immutable`.
...
extern void wasi_http_types_method_request_options_connect_timeout(wasi_http_types_borrow_request_options_t self, archive_option_duration_t *ret);
// Set the timeout for the initial connect to the HTTP Server. An error
// return value indicates that this timeout is not supported.
extern void wasi_http_types_method_request_options_set_connect_timeout(wasi_http_types_borrow_request_options_t self, archive_option_duration_t *duration, wasi_http_types_result_void_void_t *ret);
// The timeout for receiving the first byte of the Response body.
extern void wasi_http_types_method_request_options_first_byte_timeout(wasi_http_types_borrow_request_options_t self, archive_option_duration_t *ret);
// Set the timeout for receiving the first byte of the Response body. An
// error return value indicates that this timeout is not supported.
extern void wasi_http_types_method_request_options_set_first_byte_timeout(wasi_http_types_borrow_request_options_t self, archive_option_duration_t *duration, wasi_http_types_result_void_void_t *ret);
// The timeout for receiving subsequent chunks of bytes in the Response
// body stream.
extern void wasi_http_types_method_request_options_between_bytes_timeout(wasi_http_types_borrow_request_options_t self, archive_option_duration_t *ret);
// Set the timeout for receiving subsequent chunks of bytes in the Response
// body stream. An error return value indicates that this timeout is not
// supported.
extern void wasi_http_types_method_request_options_set_between_bytes_timeout(wasi_http_types_borrow_request_options_t self, archive_option_duration_t *duration, wasi_http_types_result_void_void_t *ret);
...
// text.
extern void wasi_logging_logging_log(wasi_logging_logging_level_t level, archive_string_t *context, archive_string_t *message);
...
// data.
extern void wasi_random_random_get_random_bytes(uint64_t len, archive_list_u8_t *ret);
...
// a long period.
extern void wasi_random_insecure_get_insecure_random_bytes(uint64_t len, archive_list_u8_t *ret);
...
// protection.
extern void wasi_random_insecure_seed_insecure_seed(archive_tuple2_u64_u64_t *ret);
...
extern void wasi_sockets_ip_name_lookup_resolve_addresses(wasi_sockets_ip_name_lookup_borrow_network_t network, archive_string_t *name, wasi_sockets_ip_name_lookup_result_own_resolve_address_stream_error_code_t *ret);
...
void exports_demo_archive_api_store(archive_string_t *name, archive_list_string_t *items);
void exports_demo_archive_api_get_all(exports_demo_archive_api_list_archived_list_t *ret);
...
extern void golem_rpc_types_wasm_rpc_drop_own(golem_rpc_types_own_wasm_rpc_t handle);

extern golem_rpc_types_borrow_wasm_rpc_t golem_rpc_types_borrow_wasm_rpc(golem_rpc_types_own_wasm_rpc_t handle);

extern void golem_rpc_types_future_invoke_result_drop_own(golem_rpc_types_own_future_invoke_result_t handle);

extern golem_rpc_types_borrow_future_invoke_result_t golem_rpc_types_borrow_future_invoke_result(golem_rpc_types_own_future_invoke_result_t handle);
...
extern void wasi_blobstore_types_outgoing_value_drop_own(wasi_blobstore_types_own_outgoing_value_t handle);

extern wasi_blobstore_types_borrow_outgoing_value_t wasi_blobstore_types_borrow_outgoing_value(wasi_blobstore_types_own_outgoing_value_t handle);

extern void wasi_blobstore_types_incoming_value_drop_own(wasi_blobstore_types_own_incoming_value_t handle);

extern wasi_blobstore_types_borrow_incoming_value_t wasi_blobstore_types_borrow_incoming_value(wasi_blobstore_types_own_incoming_value_t handle);
...
extern void wasi_blobstore_container_container_drop_own(wasi_blobstore_container_own_container_t handle);

extern wasi_blobstore_container_borrow_container_t wasi_blobstore_container_borrow_container(wasi_blobstore_container_own_container_t handle);

extern void wasi_blobstore_container_stream_object_names_drop_own(wasi_blobstore_container_own_stream_object_names_t handle);

extern wasi_blobstore_container_borrow_stream_object_names_t wasi_blobstore_container_borrow_stream_object_names(wasi_blobstore_container_own_stream_object_names_t handle);
