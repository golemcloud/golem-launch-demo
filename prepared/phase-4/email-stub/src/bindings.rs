...
pub mod demo {
    ...
    pub mod email {
        ...
        pub mod api {
            ...
            pub fn send_email(list_uri: &Uri) {
                unsafe {
                    let super::super::super::golem::rpc::types::Uri { value: value0 } = list_uri;
                    let vec1 = value0;
                    let ptr1 = vec1.as_ptr().cast::<u8>();
                    let len1 = vec1.len();

                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "demo:email/api")]
                    extern "C" {
    ...
    pub mod demo {
        ...
        pub mod email_stub {
            ...
            pub mod stub_email {
                ...
                pub type Uri = super::super::super::super::demo::email::api::Uri;
                ...
                unsafe impl _rt::WasmResource for Api {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            #[link(wasm_import_module = "[export]demo:email-stub/stub-email")]
                            extern "C" {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_api_blocking_send_email_cabi<T: GuestApi>(
                    arg0: *mut u8,
                    arg1: *mut u8,
                    arg2: usize,
                ) {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_api_send_email_cabi<T: GuestApi>(
                    arg0: *mut u8,
                    arg1: *mut u8,
                    arg2: usize,
                ) {
                ...
                pub trait GuestApi: 'static {
                    ...
                    fn blocking_send_email(&self, list_uri: Uri);
                    fn send_email(&self, list_uri: Uri);
                }
                #[doc(hidden)]

                macro_rules! __export_demo_email_stub_stub_email_cabi{
                                  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

                                    #[export_name = "demo:email-stub/stub-email#[constructor]api"]
                                    ...
                                    #[export_name = "demo:email-stub/stub-email#[method]api.blocking-send-email"]
                                    unsafe extern "C" fn export_method_api_blocking_send_email(arg0: *mut u8,arg1: *mut u8,arg2: usize,) {
                                      $($path_to_types)*::_export_method_api_blocking_send_email_cabi::<<$ty as $($path_to_types)*::Guest>::Api>(arg0, arg1, arg2)
                                    }
                                    #[export_name = "demo:email-stub/stub-email#[method]api.send-email"]
                                    unsafe extern "C" fn export_method_api_send_email(arg0: *mut u8,arg1: *mut u8,arg2: usize,) {
                                      $($path_to_types)*::_export_method_api_send_email_cabi::<<$ty as $($path_to_types)*::Guest>::Api>(arg0, arg1, arg2)
                                    }

                                    const _: () = {
                                      #[doc(hidden)]
                                      #[export_name = "demo:email-stub/stub-email#[dtor]api"]
                                      #[allow(non_snake_case)]
                ...
                #[doc(hidden)]
                pub(crate) use __export_demo_email_stub_stub_email_cabi;
            }
        }
    }
}
...
macro_rules! __export_wasm_rpc_stub_email_impl {
                          ($ty:ident) => (self::export!($ty with_types_in self););
                          ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
                          $($path_to_types_root)*::exports::demo::email_stub::stub_email::__export_demo_email_stub_stub_email_cabi!($ty with_types_in $($path_to_types_root)*::exports::demo::email_stub::stub_email);
                          )
                        }
#[doc(inline)]
pub(crate) use __export_wasm_rpc_stub_email_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:wasm-rpc-stub-email:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1645] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xe3\x0b\x01A\x02\x01\
...
ult.get\x01#\x03\x01\x15golem:rpc/types@0.1.0\x05\x02\x02\x03\0\x01\x03uri\x01B\x04\
\x02\x03\x02\x01\x03\x04\0\x03uri\x03\0\0\x01@\x01\x08list-uri\x01\x01\0\x04\0\x0a\
send-email\x01\x02\x03\x01\x0edemo:email/api\x05\x04\x02\x03\0\x02\x03uri\x01B\x0e\
\x02\x03\x02\x01\x03\x04\0\x0dgolem-rpc-uri\x03\0\0\x02\x03\x02\x01\x01\x04\0\x10\
wasi-io-pollable\x03\0\x02\x02\x03\x02\x01\x05\x04\0\x03uri\x03\0\x04\x04\0\x03a\
pi\x03\x01\x01i\x06\x01@\x01\x08location\x01\0\x07\x04\0\x10[constructor]api\x01\
\x08\x01h\x06\x01@\x02\x04self\x09\x08list-uri\x05\x01\0\x04\0\x1f[method]api.bl\
ocking-send-email\x01\x0a\x04\0\x16[method]api.send-email\x01\x0a\x04\x01\x1adem\
o:email-stub/stub-email\x05\x06\x04\x01#demo:email-stub/wasm-rpc-stub-email\x04\0\
\x0b\x19\x01\0\x13wasm-rpc-stub-email\x03\0\0\0G\x09producers\x01\x0cprocessed-b\
