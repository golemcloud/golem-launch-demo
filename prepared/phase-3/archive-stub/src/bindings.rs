...
pub mod demo {
    ...
    pub mod archive {
        ...
        pub mod api {
            ...
            pub fn store(name: &str, items: &[_rt::String]) {
                unsafe {
                    let vec0 = name;
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "demo:archive/api")]
                    extern "C" {
                        #[link_name = "store"]
                    ...
                    wit_import(ptr0.cast_mut(), len0, result2, len2);
                    if layout2.size() != 0 {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn get_all() -> _rt::Vec<ArchivedList> {
                unsafe {
                    #[repr(align(4))]
    ...
    pub mod demo {
        ...
        pub mod archive_stub {
            ...
            pub mod stub_archive {
                ...
                pub type ArchivedList =
                    super::super::super::super::demo::archive::api::ArchivedList;

                #[derive(Debug)]
                #[repr(transparent)]
                pub struct FutureGetAllResult {
                    handle: _rt::Resource<FutureGetAllResult>,
                }

                type _FutureGetAllResultRep<T> = Option<T>;

                impl FutureGetAllResult {
                    /// Creates a new resource from the specified representation.
                    ///
                    /// This function will create a new resource handle by moving `val` onto
                    /// the heap and then passing that heap pointer to the component model to
                    /// create a handle. The owned handle is then returned as `FutureGetAllResult`.
                    pub fn new<T: GuestFutureGetAllResult>(val: T) -> Self {
                        Self::type_guard::<T>();
                        let val: _FutureGetAllResultRep<T> = Some(val);
                        let ptr: *mut _FutureGetAllResultRep<T> =
                            _rt::Box::into_raw(_rt::Box::new(val));
                        unsafe { Self::from_handle(T::_resource_new(ptr.cast())) }
                    }

                    /// Gets access to the underlying `T` which represents this resource.
                    pub fn get<T: GuestFutureGetAllResult>(&self) -> &T {
                    ...
                    /// resource.
                    pub fn get_mut<T: GuestFutureGetAllResult>(&mut self) -> &mut T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.as_mut().unwrap()
                    }

                    /// Consumes this resource and returns the underlying `T`.
                    pub fn into_inner<T: GuestFutureGetAllResult>(self) -> T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.take().unwrap()
                    }
                    ...
                    // It's theoretically possible to implement the `GuestFutureGetAllResult` trait twice
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = _rt::Box::from_raw(handle as *mut _FutureGetAllResultRep<T>);
                    }

                    fn as_ptr<T: GuestFutureGetAllResult>(&self) -> *mut _FutureGetAllResultRep<T> {
                        FutureGetAllResult::type_guard::<T>();
                        T::_resource_rep(self.handle()).cast()
                    }
                }

                /// A borrowed version of [`FutureGetAllResult`] which represents a borrowed value
                /// with the lifetime `'a`.
                #[derive(Debug)]
                #[repr(transparent)]
                pub struct FutureGetAllResultBorrow<'a> {
                    rep: *mut u8,
                    _marker: core::marker::PhantomData<&'a FutureGetAllResult>,
                }

                impl<'a> FutureGetAllResultBorrow<'a> {
                    #[doc(hidden)]
                    ...
                    fn as_ptr<T: 'static>(&self) -> *mut _FutureGetAllResultRep<T> {
                        FutureGetAllResult::type_guard::<T>();
                        self.rep.cast()
                    }
                }

                unsafe impl _rt::WasmResource for FutureGetAllResult {
                    #[inline]
                    unsafe fn drop(_handle: u32) {
                        #[cfg(not(target_arch = "wasm32"))]
                        unreachable!();
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            #[link(wasm_import_module = "[export]demo:archive-stub/stub-archive")]
                            extern "C" {
                                #[link_name = "[resource-drop]future-get-all-result"]
                                fn drop(_: u32);
                            }
                ...
                pub unsafe fn _export_method_future_get_all_result_subscribe_cabi<
                    T: GuestFutureGetAllResult,
                >(
                    arg0: *mut u8,
                ) -> i32 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 =
                        T::subscribe(FutureGetAllResultBorrow::lift(arg0 as u32 as usize).get());
                    (result0).take_handle() as i32
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_future_get_all_result_get_cabi<
                    T: GuestFutureGetAllResult,
                >(
                    arg0: *mut u8,
                ) -> *mut u8 {
                    ...
                    _rt::run_ctors_once();
                    let result0 =
                        T::get(FutureGetAllResultBorrow::lift(arg0 as u32 as usize).get());
                        ...
                        Some(e) => {
                            *ptr1.add(0).cast::<u8>() = (1i32) as u8;
                            ...
                            for (i, e) in vec6.into_iter().enumerate() {
                                ...
                                {
                                    let super::super::super::super::demo::archive::api::ArchivedList{ name:name2, items:items2, } = e;
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_future_get_all_result_get<
                    T: GuestFutureGetAllResult,
                >(
                    arg0: *mut u8,
                ) {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_api_blocking_store_cabi<T: GuestApi>(
                    arg0: *mut u8,
                    arg1: *mut u8,
                    arg2: usize,
                    arg3: *mut u8,
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_api_store_cabi<T: GuestApi>(
                    arg0: *mut u8,
                    arg1: *mut u8,
                    arg2: usize,
                    arg3: *mut u8,
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_api_blocking_get_all_cabi<T: GuestApi>(
                    arg0: *mut u8,
                ) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::blocking_get_all(ApiBorrow::lift(arg0 as u32 as usize).get());
                    let ptr1 = _RET_AREA.0.as_mut_ptr().cast::<u8>();
                    let vec6 = result0;
                    let len6 = vec6.len();
                    ...
                    for (i, e) in vec6.into_iter().enumerate() {
                        let base = result6.add(i * 16);
                        {
                            let super::super::super::super::demo::archive::api::ArchivedList {
                                name: name2,
                                items: items2,
                            } = e;
                            let vec3 = (name2.into_bytes()).into_boxed_slice();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_api_blocking_get_all<T: GuestApi>(
                    arg0: *mut u8,
                ) {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_api_get_all_cabi<T: GuestApi>(arg0: *mut u8) -> i32 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::get_all(ApiBorrow::lift(arg0 as u32 as usize).get());
                    (result0).take_handle() as i32
                }
                pub trait Guest {
                    type FutureGetAllResult: GuestFutureGetAllResult;
                    type Api: GuestApi;
                }
                pub trait GuestFutureGetAllResult: 'static {
                    #[doc(hidden)]
                        ...
                        Self: Sized,
                    {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            #[link(wasm_import_module = "[export]demo:archive-stub/stub-archive")]
                            extern "C" {
                                #[link_name = "[resource-new]future-get-all-result"]
                                fn new(_: *mut u8) -> u32;
                            }
                            new(val)
                        }
                        ...
                        Self: Sized,
                    {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            #[link(wasm_import_module = "[export]demo:archive-stub/stub-archive")]
                            extern "C" {
                                #[link_name = "[resource-rep]future-get-all-result"]
                                fn rep(_: u32) -> *mut u8;
                            }
                            unsafe { rep(handle) }
                        }
                    ...
                    fn get(&self) -> Option<_rt::Vec<ArchivedList>>;
                }
                pub trait GuestApi: 'static {
                    ...
                    fn blocking_store(&self, name: _rt::String, items: _rt::Vec<_rt::String>);
                    fn store(&self, name: _rt::String, items: _rt::Vec<_rt::String>);
                    fn blocking_get_all(&self) -> _rt::Vec<ArchivedList>;
                    fn get_all(&self) -> FutureGetAllResult;
                }
                #[doc(hidden)]

                macro_rules! __export_demo_archive_stub_stub_archive_cabi{
                          ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

                            #[export_name = "demo:archive-stub/stub-archive#[method]future-get-all-result.subscribe"]
                            unsafe extern "C" fn export_method_future_get_all_result_subscribe(arg0: *mut u8,) -> i32 {
                              $($path_to_types)*::_export_method_future_get_all_result_subscribe_cabi::<<$ty as $($path_to_types)*::Guest>::FutureGetAllResult>(arg0)
                            }
                            #[export_name = "demo:archive-stub/stub-archive#[method]future-get-all-result.get"]
                            unsafe extern "C" fn export_method_future_get_all_result_get(arg0: *mut u8,) -> *mut u8 {
                              $($path_to_types)*::_export_method_future_get_all_result_get_cabi::<<$ty as $($path_to_types)*::Guest>::FutureGetAllResult>(arg0)
                            }
                            #[export_name = "cabi_post_demo:archive-stub/stub-archive#[method]future-get-all-result.get"]
                            unsafe extern "C" fn _post_return_method_future_get_all_result_get(arg0: *mut u8,) {
                              $($path_to_types)*::__post_return_method_future_get_all_result_get::<<$ty as $($path_to_types)*::Guest>::FutureGetAllResult>(arg0)
                            }
                            #[export_name = "demo:archive-stub/stub-archive#[constructor]api"]
                            ...
                            #[export_name = "demo:archive-stub/stub-archive#[method]api.blocking-store"]
                            unsafe extern "C" fn export_method_api_blocking_store(arg0: *mut u8,arg1: *mut u8,arg2: usize,arg3: *mut u8,arg4: usize,) {
                              $($path_to_types)*::_export_method_api_blocking_store_cabi::<<$ty as $($path_to_types)*::Guest>::Api>(arg0, arg1, arg2, arg3, arg4)
                            }
                            #[export_name = "demo:archive-stub/stub-archive#[method]api.store"]
                            unsafe extern "C" fn export_method_api_store(arg0: *mut u8,arg1: *mut u8,arg2: usize,arg3: *mut u8,arg4: usize,) {
                              $($path_to_types)*::_export_method_api_store_cabi::<<$ty as $($path_to_types)*::Guest>::Api>(arg0, arg1, arg2, arg3, arg4)
                            }
                            #[export_name = "demo:archive-stub/stub-archive#[method]api.blocking-get-all"]
                            unsafe extern "C" fn export_method_api_blocking_get_all(arg0: *mut u8,) -> *mut u8 {
                              $($path_to_types)*::_export_method_api_blocking_get_all_cabi::<<$ty as $($path_to_types)*::Guest>::Api>(arg0)
                            }
                            #[export_name = "cabi_post_demo:archive-stub/stub-archive#[method]api.blocking-get-all"]
                            unsafe extern "C" fn _post_return_method_api_blocking_get_all(arg0: *mut u8,) {
                              $($path_to_types)*::__post_return_method_api_blocking_get_all::<<$ty as $($path_to_types)*::Guest>::Api>(arg0)
                            }
                            #[export_name = "demo:archive-stub/stub-archive#[method]api.get-all"]
                            unsafe extern "C" fn export_method_api_get_all(arg0: *mut u8,) -> i32 {
                              $($path_to_types)*::_export_method_api_get_all_cabi::<<$ty as $($path_to_types)*::Guest>::Api>(arg0)
                            }

                            const _: () = {
                              #[doc(hidden)]
                              #[export_name = "demo:archive-stub/stub-archive#[dtor]future-get-all-result"]
                              #[allow(non_snake_case)]
                              unsafe extern "C" fn dtor(rep: *mut u8) {
                                $($path_to_types)*::FutureGetAllResult::dtor::<
                                <$ty as $($path_to_types)*::Guest>::FutureGetAllResult
                                >(rep)
                              }
                            };
                            ...
                            const _: () = {
                              #[doc(hidden)]
                              #[export_name = "demo:archive-stub/stub-archive#[dtor]api"]
                              #[allow(non_snake_case)]
                              unsafe extern "C" fn dtor(rep: *mut u8) {
                ...
                #[doc(hidden)]
                pub(crate) use __export_demo_archive_stub_stub_archive_cabi;
                #[repr(align(4))]
...
macro_rules! __export_wasm_rpc_stub_archive_impl {
                  ($ty:ident) => (self::export!($ty with_types_in self););
                  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
                  $($path_to_types_root)*::exports::demo::archive_stub::stub_archive::__export_demo_archive_stub_stub_archive_cabi!($ty with_types_in $($path_to_types_root)*::exports::demo::archive_stub::stub_archive);
                  )
                }
#[doc(inline)]
pub(crate) use __export_wasm_rpc_stub_archive_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:wasm-rpc-stub-archive:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1921] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf5\x0d\x01A\x02\x01\
...
ult.get\x01#\x03\x01\x15golem:rpc/types@0.1.0\x05\x02\x01B\x08\x01ps\x01r\x02\x04\
names\x05items\0\x04\0\x0darchived-list\x03\0\x01\x01@\x02\x04names\x05items\0\x01\
\0\x04\0\x05store\x01\x03\x01p\x02\x01@\0\0\x04\x04\0\x07get-all\x01\x05\x03\x01\
\x10demo:archive/api\x05\x03\x02\x03\0\x01\x03uri\x02\x03\0\x02\x0darchived-list\
\x01B\x1d\x02\x03\x02\x01\x04\x04\0\x03uri\x03\0\0\x02\x03\x02\x01\x01\x04\0\x08\
pollable\x03\0\x02\x02\x03\x02\x01\x05\x04\0\x0darchived-list\x03\0\x04\x04\0\x15\
future-get-all-result\x03\x01\x04\0\x03api\x03\x01\x01h\x06\x01i\x03\x01@\x01\x04\
self\x08\0\x09\x04\0'[method]future-get-all-result.subscribe\x01\x0a\x01p\x05\x01\
k\x0b\x01@\x01\x04self\x08\0\x0c\x04\0![method]future-get-all-result.get\x01\x0d\
\x01i\x07\x01@\x01\x08location\x01\0\x0e\x04\0\x10[constructor]api\x01\x0f\x01h\x07\
\x01ps\x01@\x03\x04self\x10\x04names\x05items\x11\x01\0\x04\0\x1a[method]api.blo\
cking-store\x01\x12\x04\0\x11[method]api.store\x01\x12\x01@\x01\x04self\x10\0\x0b\
\x04\0\x1c[method]api.blocking-get-all\x01\x13\x01i\x06\x01@\x01\x04self\x10\0\x14\
\x04\0\x13[method]api.get-all\x01\x15\x04\x01\x1edemo:archive-stub/stub-archive\x05\
\x06\x04\x01'demo:archive-stub/wasm-rpc-stub-archive\x04\0\x0b\x1b\x01\0\x15wasm\
-rpc-stub-archive\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compone\
